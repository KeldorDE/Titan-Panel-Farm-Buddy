...
L["FARM_BUDDY_COMMAND_PRIMARY_ARGS"] = "Position zwischen 1 und !max!"
L["FARM_BUDDY_COMMAND_PRIMARY_DESC"] = "Setzt die Position des Gegenstands, der in der Titan Panel Leiste angezeigt wird."
...
L["FARM_BUDDY_COMMAND_TRACK_ARGS"] = "Gegenstand ID | Gegenstand Link | Gegenstand Name"
...
L["FARM_BUDDY_INVALID_NUMBER"] = "Die eingegebene Nummer ist ungültig."
L["FARM_BUDDY_INVENTORY"] = "Inventar"
L["FARM_BUDDY_ITEM"] = "Gegenstand"
L["FARM_BUDDY_ITEM_DISPLAY_STYLE"] = "Anzeigetyp für Gegenstände in der Titan Panel Leiste"
...
L["FARM_BUDDY_ITEM_SET_POSITION_MSG"] = "Die eingegebene Position ist nicht gültig. Bitte gib eine Position zwischen 1 und !max! ein."
L["FARM_BUDDY_ITEM_TO_TRACK_DESC"] = "Der Names des Gegenstands der Beobachtet werden soll"
L["FARM_BUDDY_ITEM_TO_TRACK_USAGE"] = "Gib den Namen, die ID oder den Itemlink des Gegenstands ein, um diesen hinzuzufügen.\n\nHinweis: Der Gegenstand muss in deinem World of Warcraft Cache bekannt sein, damit dieser von den Addon API Funktionen erkannt wird."
...
L["FARM_BUDDY_SHOW_IN_BAR"] = "Primär"
L["FARM_BUDDY_SHOW_IN_BAR_DESC"] = "Wenn diese Checkbox aktiviert ist, wird der Farm Status des Gegenstands in der Titan Leiste angezeigt."
...
L["FARM_BUDDY_TOOLTIP_DESC"] = "Linksklick, um die Einstellungen zu öffnen."
L["FARM_BUDDY_TOOLTIP_MODIFIER"] = "Alt + Rechtsklick auf einen Gegenstand in der Tasche, um diesen auszuwählen."
...
L["FARM_BUDDY_TRACKING_DESC"] = "Hier können bis zu !amount! Gegenstände konfiguriert werden. Verwende einen Namen, eine ID oder einen Itemlink."
L["FARM_BUDDY_TRACKING_CACHE_WARNING"] = "Hinweis: Der Gegenstand muss in deinem World of Warcraft Cache bekannt sein, damit dieser von den Addon API Funktionen erkannt wird."
...
L["FARM_BUDDY_HIDE_NOTIFICATIONS_IN_COMBAT_DESC"] = "Wenn diese Option aktiviert ist, werden Benachrichtigungen während des Kampfes ausgeblendet."
L["FARM_BUDDY_ITEM_ALREADY_TRACKED"] = "!itemName! wird bereits auf Position !position! beobachtet."
L["FARM_BUDDY_WARBAND_BANK"] = "Kriegsmeutenbank"
L["FARM_BUDDY_DISPLAY"] = "Anzeige"
L["FARM_BUDDY_COUNTING"] = "Zählung"
L["FARM_BUDDY_DANGER_ZONE"] = "Gefahrenzone"
